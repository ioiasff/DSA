...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to gpbot!\n\nTo get a list of gpbot groups use /chats or /chatlist for a document list of chats.\n\nTo get a new gp bot group, contact a  group:\n\nFor group, use: /join [id]\n\nFor all group, use: /join [id]\n\nFor more information, check out our channels:\n\n@githubCH [persian]\n@githuben [english]\n\nThanks for using gpbot!"
     	return text
    end
